import { db, analytics } from './firebase-config.min.js';
import { collection, getDocs, query, orderBy } from "https://www.gstatic.com/firebasejs/10.11.1/firebase-firestore.js";
import { logEvent } from "https://www.gstatic.com/firebasejs/10.11.1/firebase-analytics.js";
...
<a href="${waLink}" target="_blank" rel="noopener noreferrer" class="wa-btn" onclick="logProductClick('${product.id}', '${product.name}')">
...
logEvent(analytics, 'page_view', { page_title: 'Blush & Bloom Shop' });
window.logProductClick = (id, name) => logEvent(analytics, 'select_item', { item_id: id, item_name: name });
createParticles();
initNavbar();
fetchProducts();
fetchCategories();
